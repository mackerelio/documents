...
|`incoming_ipv6`|*array[string]*|IPv6 address ranges that Mackerel receives<br><ul><li>[Mackerel's IP address ranges](https://support.mackerel.io/hc/en-us/articles/360039633271)</li></ul>|
