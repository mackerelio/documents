...
Mackerel supports obtaining and monitoring <a href="https://azure.microsoft.com/en-us/services/postgresql/" target="_blank">Database for PostgreSQL</a> metrics in Azure Integration. Billable targets are determined using the conversion 1 resource = 1 Micro Host. (Currently the only supported deployment option is "Single server")
