...
- `CloudWatchReadOnlyAccess`（When only configuring CloudFront, API Gateway, Kinesis, S3, or ES）
...
- `AmazonKinesisReadOnlyAccess`
- `AmazonS3ReadOnlyAccess`
- `CloudWatchReadOnlyAccess`（When only configuring CloudFront, API Gateway, Kinesis, or S3）
