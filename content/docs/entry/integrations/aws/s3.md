...
<a href="https://docs.aws.amazon.com/en_us/AmazonS3/latest/userguide/configure-request-metrics-bucket.html">How to Configure Request Metrics for an S3 Bucket</a>
...
- Assigning roles by tags is not available with AWS Integration S3 support.
