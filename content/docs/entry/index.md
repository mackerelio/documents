...
<ul id="internal-links">
  <li><a href="#first-steps">Getting Started</a></li>
  <li><a href="#accounts">User Account Management</a></li>
  <li><a href="#apm">Application Performance Monitoring (APM)</a></li>
  <li><a href="#infra-hosts">Infrastructure and Host Monitoring</a></li>
  <li><a href="#monitoring-notifications">Monitoring and Notifications</a></li>
...
<h4>Infrastructure and Host Monitoring</h4>
<ul>
...
<h4>Monitoring and Notifications</h4>
<ul>
  ...
  <li><a href="https://mackerel.io/docs/entry/howto/check/process"><strong>Monitoring Processes</strong><span>monitor process counts</span></a></li>
  <li><a href="https://mackerel.io/docs/entry/howto/mkr/wrap"><strong>Monitoring Batch Jobs like cron</strong><span>monitor batch jobs like cron with mkr wrap</span></a></li>
  ...
  <li><a href="https://mackerel.io/docs/entry/howto/alerts/email"><strong>Sending Alerts to Email</strong><span>send alerts via email</span></a></li>
...
<ul>
  ...
  <li><a href="https://mackerel.io/docs/entry/advanced/install-plugin-by-mkr"><strong>Installing Plugins with mkr plugin install</strong><span>easily install mackerel plugins and check plugins using mkr</span></a></li>
  <li><a href="https://mackerel.io/docs/entry/advanced/go-mackerel-plugin"><strong>Using go-mackerel-plugin to create a custom metric plugin</strong><span>an introduction on how to create plugins using the official library</span></a></li>
  <li><a href="https://mackerel.io/docs/entry/advanced/checkers"><strong>Creating Check Plugins Using checkers</strong><span>introduces how to create check plugins using the officially provided library</span></a></li>
  <li><a href="https://mackerel.io/docs/entry/advanced/make-plugin-corresponding-to-installer"><strong>Creating Plugins Compatible with mkr plugin install</strong><span>introduces how to make your created plugins compatible with mkr's plugin installer</span></a></li>
