...
| `type`          | *string* | the type of notification channel (`"email"`, `"slack"`, `"line"`, `"chatwork"`, `"typetalk"`, `"twilio"`, `"pagerduty"`, `"opsgenie"`, `"jira-service-management"`, `"microsoft-teams`, `"webhook"`, `"amazon-event-bridge"`) |
