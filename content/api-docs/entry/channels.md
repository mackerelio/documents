...
| `type`          | *string* | the type of notification channel (`"email"`, `"email-broadcast"`, `"slack"`, `"line"`, `"chatwork"`, `"twilio"`, `"pagerduty"`, `"opsgenie"`, `"jira-service-management"`, `"microsoft-teams`, `"webhook"`, `"amazon-event-bridge"`) |
