...
| `type`          | *string* | 通知チャンネルの種類 (`"email"`, `"email-broadcast"`, `"slack"`, `"line"`, `"chatwork"`, `"twilio"`, `"pagerduty"`, `"opsgenie"`, `"jira-service-management"`, `"microsoft-teams`, `"webhook"`, `"amazon-event-bridge"` のいずれかです) |
